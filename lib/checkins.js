...
module.exports = function(config) {
   ...
   */
  function likeCheckin(checkinId, params, accessToken, callback) {
    logger.enter('likeCheckin');

    if(!checkinId) {
      logger.error('likeCheckin: checkinId is required.');
      callback(new Error('Checkins.likeCheckin: checkinId is required.'));
      return;
    }
    ...
    core.callApi(path.join('/checkins', checkinId, 'like'), accessToken, params, callback, 'POST');
  }
