...
module.exports = function(config) {
  ...
  function configure(config) {
    ...
    if(!config.secrets || !config.secrets.clientId || !config.secrets.clientSecret) {
      logger.error(
        'Client configuration not supplied; add config.secrets information, (clientId, clientSecret).'
      );
